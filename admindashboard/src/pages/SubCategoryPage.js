...
export default function UserPage() {
  ...
  useEffect(() => {
    ...
    const fetchsubcategoryData = async () => {
      try {
        const response = await axios.get('http://localhost:8001/subcategory/get-allSubCategory'); // Replace with your API endpoint
  ...
  const onDeleteHandler = (subcategoryid) => {
    axios
      .delete(`http://localhost:8001/subcategory/deleteSubCategory/${subcategoryid}`)
      .then(() => {
              ...
              <Table>
                ...
                <TableBody>
                  {filteredsubcategory.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { _id, name, category ,image, createdAt } = row;
                      ...
                      <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            <img
                              alt="io"
                              src={`http://localhost:8001/uploads/subCategory/${image}`}
                              width={100}
                              height={70}
