...
export default function UserPage() {
  ...
  useEffect(() => {
    ...
    const fetchcategoryData = async () => {
      try {
        const response = await axios.get('http://localhost:8001/category/get-categoryAll'); // Replace with your API endpoint
  ...
  const onDeleteHandler = (categoryid) => {
    axios
      .delete(`http://localhost:8001/category/deleteCategory/${categoryid}`)
      .then(() => {
                      ...
                      <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                        ...
                        <TableCell component="th" scope="row" padding="none">
                          <Stack direction="row" alignItems="center" spacing={2}>
                            <img
                              alt="io"
                              src={`http://localhost:8001/uploads/category/${image}`}
                              width={50}
                              height={50}
                        ...
                        <TableCell>
                          ...
                          <Iconify icon={'eva:edit-2-outline'} sx={{ mr: 2 }} style={{textDecoration:"none", color:"blue"}} />
